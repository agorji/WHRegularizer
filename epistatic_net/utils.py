'''
SPRIGHT utils from EpistaticNet Github repo:
https://github.com/amirmohan/epistatic-net/blob/main/utils.py
'''
...
class SPRIGHT:
    def __init__(self, experiment_type, run_list, spright_sample: SPRIGHTSample, model_to_remove=None):
        ...
        self.sampling_matrix3 = spright_sample.sampling_matrices[2]
        
        self.delays_matrix1 = spright_sample.delay_matrices[0]
        self.delays_matrix2 = spright_sample.delay_matrices[1]
        self.delays_matrix3 = spright_sample.delay_matrices[2]
        
        self.all_sampling_locations1 = spright_sample.sampling_locations[0]
        self.all_sampling_locations2 = spright_sample.sampling_locations[1]
        self.all_sampling_locations3 = spright_sample.sampling_locations[2]
